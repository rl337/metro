...
def generate(
    ...
    output_file: str = typer.Option(
        "city.json", help="The output file to save the city configuration."
    ),
):
    """
    ...
    print(
        f"Generating a city with a population of {population} and random seed {seed}."
    )
    ...
    city_model = CityModel(
        ...
        occupations={
            ...
            for name, data in population_model.occupations.items()
        },
