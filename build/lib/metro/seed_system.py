...
class CitySeedManager:
    ...
    def create_city_variation(self, variation_type: str, variation_value: str) -> 'CitySeedManager':
        """
        ...
        """
        variation_seed = self.generator.create_variation("master", f"{variation_type}.{variation_value}")
